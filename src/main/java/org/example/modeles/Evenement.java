...
public class Evenement {
    ...
    public Evenement(int id, Date dateEvenement, double latitude, double longitude, String nomEvenement, int organisateurId, String typeEvent ,String commentairesEvenement) {
        this.id = id;
